...
public class UserServiceDelegate {
	...
	public String paginationCustomerResults(PaginationResult pagination)throws SQLException, IOException, TemplateException 
	{
	...
	public String changePassword(UserVO userDetails) {
		 Connection con=ConnectionHelper.getConnection();
		 String status=userServiceBo.changePassword(userDetails,con);
		 ConnectionHelper.colseConnection(con);
		 return status;
	}
}
